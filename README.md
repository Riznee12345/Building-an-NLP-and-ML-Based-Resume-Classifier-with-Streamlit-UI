...
A machine learning-based web application that classifies resumes into predefined job categories using Natural Language Processing (NLP). Built with Python, Scikit-learn, and Streamlit, this tool helps recruiters quickly identify the right candidates based on resume content.
